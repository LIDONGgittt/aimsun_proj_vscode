...
extern "C" {
    ...
    AAPIEXPORT int ECIGetSignalGroupYellowBeforeGreenDuration(int idJunction, int signalPos, double timeSta );
    ...
    AAPIEXPORT int ECIGetYellowTimeBeforeGreenPhase(int idJunction, int idPhase, double timeSta, double *yellowBeforeGreen);
    AAPIEXPORT int ECISetYellowTimeBeforeGreenPhase(int idJunction, int idPhase, double timeSta, double yellowBeforeGreen);
	...
	AAPIEXPORT int ECIIsBusPreemptionNodeEnabled(int idJunction);
    ...
    AAPIEXPORT double ECIGetYellowTimeBeforeGreen(int idJunction);
	...
	AAPIEXPORT int ECIGetControlCycleofJunction(int elemControl, int ajunction);
    ...
    AAPIEXPORT double ECIGetYellowTimeBeforeGreenofJunction(int elemControl, int ajunction);
    ...
    AAPIEXPORT int ECIGetYellowTimeBeforeGreenPhaseofJunction(int elemControl, int idJunction,int idPhase,double timeSta,double *yellowBeforeGreen);
    AAPIEXPORT int ECISetYellowTimeBeforeGreenPhaseofJunction(int elemControl, int idJunction,int idPhase,double yellowBeforeGreen);
	...
	AAPIEXPORT int  ECISetExternalCall(int elemControl, int ajunction, int aidphase);
    ...
    AAPIEXPORT int ECIChangeStateMeteringById(int idmetering, int aState, double Time, double Ciclo, int identity=0, double timeProportion = 0.0);
